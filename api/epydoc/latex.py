...
# $Id: latex.py,v 1.26 2004/03/09 05:07:02 edloper Exp $
#
...
% We need to use 'fullpage' with the 'headings' argument.
% This doesn't work for all Latex installs, but works for Debian.
%\usepackage{fullpage}
